...
const RouteLandingPage = ({
    ...
    const routeSlug = `auto-transport-${fromCity.toLowerCase().replace(/ /g, '-')}-to-${toCity.toLowerCase().replace(/ /g, '-')}`;
    ...
    return (
        <div className="bg-brand-dark min-h-screen text-white">
            <SEO
                ...
                canonical={`/${routeSlug}`}
                keywords={[`car shipping ${fromCity} to ${toCity}`, `auto transport ${fromCity} to ${toCity}`, 'car shipping quote', 'auto transport prices', 'ship my car']}
            />
            ...
            <section className="relative pt-24 pb-12 overflow-hidden">
                ...
                <div className="relative z-10 mx-auto max-w-7xl px-4 flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
                    ...
                    <div className="lg:w-1/2 pt-2 lg:pt-8">
                        ...
                        <div className="text-base md:text-lg text-white/80 mb-8 max-w-xl leading-relaxed">
                            {customText ? customText : (
                                <p>Hand-calculated quotes by ASE Master Techs. Delivered via email. No unsolicited calls.</p>
                            )}
                        </div>
